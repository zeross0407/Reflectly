...
final List<List<Color>> all_color = [
  [
    const Color.fromARGB(255, 255, 156, 156), // Light Sky Blue
    const Color.fromARGB(255, 255, 205, 165), // Soft Purple
  ],
  [
    const Color(0xFF657DE9), // Sky Blue
  ...
  [
    const Color.fromARGB(255, 138, 130, 200), // Light Sky Blue
    const Color.fromARGB(255, 130, 137, 229), // Soft Purple
  ],
  [
