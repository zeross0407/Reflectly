...
class _SmoothLineChartState extends State<SmoothLineChart>
  ...
  void didUpdateWidget(covariant SmoothLineChart oldWidget) {
    ...
    if (oldWidget.points.length != widget.points.length) {
      // Điều chỉnh kích thước của _oldPoints và _currentPoints khi thay đổi số lượng phần tử
  ...
  String formatDate(DateTime dateTime) {
    // Lấy ngày dưới dạng 2 chữ số, ví dụ: "08"
    String day = dateTime.day.toString().padLeft(2, '0');

    // Lấy tên tháng viết tắt bằng tiếng Anh, ví dụ: "NOV"
    String month = [
      "JAN",
      "FEB",
      "MAR",
    ...
    // Lấy 2 chữ số cuối của năm, ví dụ: "24"
