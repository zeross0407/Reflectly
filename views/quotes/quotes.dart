                    ...
                    children: [
                      CustomElement(
                        onTap: () async {
                          ...
                          await view_model.SaveQuote(_globalKey);

                          show_notification(context, "Quote save successfully",
                        ...
                        children: [
                          AnimatedSwitcher(
                            ...
                            transitionBuilder: (child, animation) {
                              // Chọn hiệu ứng chuyển tiếp, ví dụ như FadeTransition
                                    ...
                                    Padding(
                                      ...
                                      child: CustomElement(
                                        onTap: () async {
                                          ...
                                          setState(() {
                                            // Cập nhật lại giao diện hoặc thực hiện công việc gì đó
                                          });
                                        },
                                        child: Container(
