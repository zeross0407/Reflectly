...
abstract class $RegisterRequestModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String email, String password, Map<String, dynamic>? data});
}
...
class _$RegisterRequestModelImpl implements _RegisterRequestModel {
  ...
  @override
  String toString() {
    return 'RegisterRequestModel(email: $email, password: $password, data: $data)';
  }
...
abstract class _RegisterRequestModel implements RegisterRequestModel {
  const factory _RegisterRequestModel(
      ...
      final Map<String, dynamic>? data}) = _$RegisterRequestModelImpl;
