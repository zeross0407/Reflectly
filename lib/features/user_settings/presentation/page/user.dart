...
import 'package:myrefectly/core/widget/image_viewer.dart';
import 'package:myrefectly/core/route/route.dart';
...
import 'package:myrefectly/core/theme/color.dart';
import 'package:myrefectly/features/main/presentation/page/navigation_viewmodel.dart';
...
import 'package:myrefectly/features/user_settings/presentation/page/checkin_reminder.dart';
import 'package:myrefectly/features/user_settings/presentation/page/positivity_reminder.dart';
import 'package:myrefectly/features/user_settings/presentation/page/theme_selector.dart';
import 'package:myrefectly/features/user_settings/presentation/page/user_viewmodel.dart';
  ...
  Future<void> _pickImageFromGallery(User_Viewmodel view_model) async {
    ...
    setState(() {
      if (pickedFile != null) {
        ...
        //uploadImageWithProgress(_image!);
      } else {
                            ...
                            child: Column(
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: CardPosiReminder(
                                    ...
                                    countReminderChanged: (val) {
                                      view_model
                                          .user.count_positivity_reminder = val;
                                      setState(() {
                                        change_setting = true;
                                      });
                                    },
                                    ...
                                    on_time_change:
                                      ...
                                      view_model
                                          .user.start_positivity_reminder = st;
                                      view_model.user.end_positivity_reminder =
                                          end;
                                    },
                                  ),
                                ...
                                Padding(
                                  ...
                                  child: SZoomTap(
                                    onTap: () async {
                                      int rs = await view_model
                                          .request_export_entry();
                                      if (rs == 1) {
                                        // showNotification(
                                        //     context,
