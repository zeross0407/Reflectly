...
class SZoomTap extends StatefulWidget {
  ...
  const SZoomTap(
      ...
      : super(key: key);
  @override
  State<StatefulWidget> createState() => _SZoomTapState();
}

class _SZoomTapState extends State<SZoomTap>
    with SingleTickerProviderStateMixin<SZoomTap> {
