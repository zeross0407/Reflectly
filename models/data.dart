...
final List<Activity> activities_list_default = List.unmodifiable([
  Activity(UUID: "0", icon: 30, title: "weather"),
  Activity(UUID: "1", icon: 12, title: "work"),
  Activity(UUID: "2", icon: 13, title: "achievement"),
  Activity(UUID: "3", icon: 34, title: "candy"),
  Activity(UUID: "4", icon: 35, title: "gaming"),
  Activity(UUID: "5", icon: 16, title: "schedule"),
  Activity(UUID: "6", icon: 37, title: "pancake"),
  Activity(UUID: "7", icon: 38, title: "bread"),
]);

final List<Feeling> feelings_list_default = List.unmodifiable([
  Feeling(UUID: "0", icon: 2, title: "happy"),
  Feeling(UUID: "1", icon: 3, title: "confused"),
  Feeling(UUID: "2", icon: 6, title: "down"),
  Feeling(UUID: "3", icon: 67, title: "angry"),
  Feeling(UUID: "4", icon: 26, title: "awkward"),
]);
...
String server_root_url = 
"https://f8d2-104-28-254-74.ngrok-free.app";
